...
function Cart() {
  return (
    <div className="flex max-h-fit w-full flex-col gap-6 rounded-xl bg-white p-6 xl:max-w-[384px]">
      <h2 className="text-red-1 text-2xl leading-none font-bold">
        Your Cart (0)
      </h2>
      {/* <div className="flex flex-col items-center gap-4 py-4">
        ...
        <p className="text-rose-500-1 text-sm leading-none font-semibold">
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-rose-500-1 leading-none font-semibold">
                  ${item.price.toFixed(2)}
                </span>
              </div>
            </div>
            <div className="border-rose-400-1 group hover:border-rose-900-1 flex size-5 cursor-pointer items-center justify-center rounded-full border transition-colors">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="10"
                height="10"
                fill="none"
                viewBox="0 0 10 10"
                className="text-rose-400-1 group-hover:text-rose-900-1 fill-current transition-colors"
              >
      ...
      {/* order total */}
      <div className="bg-rose-50-1 flex items-center justify-center gap-2 rounded-lg p-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="21"
          height="20"
        ...
        <p className="text-rose-900-1 text-sm leading-none">
